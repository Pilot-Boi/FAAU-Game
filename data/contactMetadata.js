...
const CONTACT_METADATA = Object.freeze({
    ...
    subject_001: {
        ...
        revealOnFileRead: '/secure/avians/subjects/subject_001.txt',
        revealedNames: [
    ...
    subject_002: {
        ...
        revealOnFileRead: '/secure/avians/subjects/subject_002.txt',
        revealedNames: [
    ...
    subject_003: {
        termKey: 'subject_003',
        label: 'Subject 003',
        revealOnFileRead: '/secure/avians/subjects/subject_003.txt',
        revealedNames: [
    ...
    subject_004: {
        termKey: 'subject_004',
        label: 'Subject 004',
        revealOnFileRead: '/secure/avians/subjects/subject_004.txt',
        revealedNames: [
    ...
    subject_005: {
        termKey: 'subject_005',
        label: 'Subject 005',
        revealOnFileRead: '/secure/avians/subjects/subject_005.txt',
        revealedNames: [
    ...
    subject_006: {
        termKey: 'subject_006',
        label: 'Subject 006',
        revealOnFileRead: '/secure/avians/subjects/subject_006.txt',
        revealedNames: [
    ...
    subject_007: {
        termKey: 'subject_007',
        label: 'Subject 007',
        revealOnFileRead: '/secure/avians/subjects/subject_007.txt',
        revealedNames: [
    ...
    subject_008: {
        termKey: 'subject_008',
        label: 'Subject 008',
        revealOnFileRead: '/secure/avians/subjects/subject_008.txt',
        revealedNames: [
